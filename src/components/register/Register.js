    ...
    render() {
        ...
        return (
            <div className="tsd_login" style={{height: '100%', backgroundColor: '#FFFFFF'}}>
                <div className="logo">
                    <img src="./src/assets/login/regist_code.png" alt=""/>
                ...
                <div>
                        ...
                        <div style={{
                            ...
                            <InputItem placeholder="请输入密码" type="text"
                ...
                <List className={styles.loginList}>
                    <Button type='warning' onClick={this.handleSubmit.bind(this)}>立即注册</Button>
                </List>
...
const RegisLayout = createForm()(RegisForm);
